...
__all__ = [
    'SWPUnknownWordPronounceable', 'SLODynamic', 'SVP_20',
    'SPWORDPRONUNCIATIONLIST', 'SPAR_High', 'DISPID_SRRTimes',
    'DISPID_SRCEventInterests', 'DISPID_SRCState',
    'DISPID_SRCRetainedAudio', 'SVPOver', 'SREInterference',
    'SpeechDictationTopicSpelling', 'SPPS_RESERVED3',
    'DISPID_SVWaitUntilDone', 'SP_VISEME_3', 'ISpPhoneConverter',
    'DISPID_SGRsCommitAndSave', 'SVP_17', 'DISPID_SOTCDefault',
    'SpCompressedLexicon', 'DISPID_SRCSetAdaptationData',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEViseme',
    'DISPID_SRCRequestedUIType', 'SPEI_RESERVED2', 'SPGS_EXCLUSIVE',
    'DISPID_SPIAudioStreamPosition', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFT48kHz8BitStereo', 'SP_VISEME_15', 'SASClosed',
    'SSFMCreateForWrite', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SpeechObjectTokens', 'DISPID_SBSRead',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SABufferInfo',
    'SpeechDataKeyLocation', 'SpeechWordPronounceable',
    'SPBO_TIME_UNITS', 'DISPID_SRGState', 'Speech_Max_Word_Length',
    'DISPID_SpeechPhraseReplacement', 'SP_VISEME_9',
    'eWORDTYPE_ADDED', 'DISPID_SDKGetlongValue', 'SECFDefault',
    'DISPID_SLWLangId', 'DISPID_SAStatus', 'SAFT44kHz16BitStereo',
    'SGDSActiveWithAutoPause', 'DISPID_SRGSetWordSequenceData',
    'SAFT8kHz16BitStereo', 'SAFT11kHz8BitMono', 'SREAdaptation',
    'DISPID_SPIElements', 'SAFTGSM610_11kHzMono', 'SPEI_RECOGNITION',
    'STCAll', 'DISPID_SRRPhraseInfo', 'SAFTADPCM_8kHzStereo',
    'SPAR_Low', 'DISPID_SPRulesCount', 'DISPID_SpeechGrammarRules',
    'SRERecoOtherContext', 'SPWORDLIST', 'DISPID_SpeechLexiconWords',
    'ISpPhoneticAlphabetConverter', 'SVP_14',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpStreamFormatConverter',
    'SASPause', 'SAFT24kHz16BitStereo', 'DISPID_SVSpeakCompleteEvent',
    'ISpeechPhraseInfo', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRGDictationUnload', 'DISPID_SPPChildren',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SLPsCount', 'SPAUDIOBUFFERINFO',
    'SpeechGrammarTagDictation', 'SRTExtendableParse',
    'SPPS_RESERVED4', 'DISPID_SRSCurrentStreamNumber',
    'SPSHORTCUTPAIR', 'SVSFIsNotXML', 'DISPID_SRCEAdaptation',
    'DISPID_SGRsDynamic', 'DISPID_SGRsFindRule', 'SGSExclusive',
    'DISPID_SPEPronunciation', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRGRules', 'SVP_5', 'DISPID_SGRsCommit',
    'ISpeechAudioFormat', 'SpInprocRecognizer', 'SDTAudio',
    'ISpeechObjectTokens', 'SPPHRASEELEMENT', 'DISPID_SOTCSetId',
    'SPPS_Noun', 'DISPID_SRRGetXMLResult', 'ISpVoice',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SABIEventBias',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SFSClose',
    'DISPID_SMSSetData', 'SAFT24kHz8BitMono', 'DISPID_SRRRecoContext',
    'SVSFNLPMask', 'SECFEmulateResult', 'SGPronounciation',
    'DISPID_SRIsShared', 'SRSEIsSpeaking', 'ISpeechPhraseAlternates',
    'DISPID_SRSCurrentStreamPosition', 'SRSEDone', 'SPPHRASE',
    'SPLOADOPTIONS', 'DISPID_SLWWord', 'SPRS_ACTIVE',
    'Speech_StreamPos_RealTime', 'SpObjectToken', 'SREHypothesis',
    'eLEXTYPE_PRIVATE18', 'DISPID_SOTDataKey', 'SP_VISEME_1',
    'SVEAllEvents', 'DISPID_SVGetAudioInputs', 'SP_VISEME_8',
    'SP_VISEME_13', 'ISpObjectToken', 'SVEViseme',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCEAudioLevel', 'SGRSTTTextBuffer',
    'ISpGrammarBuilder', 'DISPID_SASCurrentDevicePosition',
    'ISpRecognizer', 'DISPID_SpeechPhraseElements', 'SGSDisabled',
    'SPCT_SUB_COMMAND', 'SVP_15', 'DISPID_SMSALineId',
    'SpeechCategoryVoices', 'SRAImport', 'SECFNoSpecialChars',
    'ISpeechPhraseReplacement', 'DISPID_SPEs_NewEnum', 'SpLexicon',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRSetPropertyNumber', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVEventInterests', 'ISpeechPhraseInfoBuilder',
    'DISPID_SBSFormat', 'eLEXTYPE_PRIVATE3', 'SREStreamStart',
    'DISPID_SPEDisplayAttributes', 'SPPS_SuppressWord',
    'DISPID_SLGenerationId', 'SPSERIALIZEDRESULT', 'SPEI_ADAPTATION',
    'ISpeechAudioBufferInfo', 'SPEI_END_INPUT_STREAM', 'SPWORD',
    'STSF_FlagCreate', 'SAFTCCITT_uLaw_8kHzStereo', 'SPPS_Verb',
    'DISPID_SpeechMemoryStream', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpMMAudioEnum', 'SINone', 'DISPID_SPCLangId',
    'DISPID_SPEActualConfidence', 'SPSEMANTICFORMAT', 'SP_VISEME_11',
    'SRSInactiveWithPurge', 'ISpeechPhraseElement', 'DISPID_SVRate',
    'SpeechPropertyResourceUsage', 'tagSTATSTG',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechLexicon',
    'SpeechVoiceCategoryTTSRate', 'SSFMOpenReadWrite', 'SP_VISEME_5',
    'SRSActive', 'SDKLCurrentUser', 'SpeechPropertyAdaptationOn',
    'SPSMF_SAPI_PROPERTIES', 'SVP_9', 'WAVEFORMATEX',
    'ISpeechRecoGrammar', 'SPRS_INACTIVE', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRState', 'SAFT48kHz8BitMono', 'eLEXTYPE_RESERVED4',
    'SPBO_NONE', 'SPRECORESULTTIMES', 'DISPID_SVEWord',
    'SDKLLocalMachine', 'SVSFUnusedFlags', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechGrammarRuleState', 'SAFTText', 'SPWAVEFORMATTYPE',
    'SBONone', 'DISPID_SGRClear', 'SRCS_Enabled',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPRuleFirstElement', 'SAFTDefault', 'SVEPhoneme',
    'SpeechTokenKeyUI', 'ISpeechObjectToken', 'STCRemoteServer',
    'SPINTERFERENCE_TOOFAST', 'SAFTCCITT_ALaw_11kHzStereo',
    'IInternetSecurityMgrSite', 'SpStream', 'DISPID_SRCERecognition',
    'SPEI_RESERVED6', 'IEnumSpObjectTokens',
    'SAFTCCITT_uLaw_11kHzMono', 'SPPHRASEREPLACEMENT',
    'SPDKL_DefaultLocation', 'DISPID_SPIStartTime', 'SPCS_ENABLED',
    'SPEI_PHONEME', 'DISPID_SRGCmdLoadFromResource',
    'SpPhoneConverter', 'SECFIgnoreWidth', 'DISPID_SPIGrammarId',
    'SAFT48kHz16BitStereo', 'SECHighConfidence', 'SpeechUserTraining',
    'SAFT32kHz16BitStereo', 'ISpRecoResult', 'Speech_StreamPos_Asap',
    'DISPID_SPERequiredConfidence', 'SpInProcRecoContext',
    'SPSHORTCUTTYPE', 'DISPID_SGRSTsCount', 'SPLO_DYNAMIC',
    'DISPID_SpeechCustomStream', 'SPBO_AHEAD',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGDictationSetState',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechDataKey', 'SPSFunction',
    'SAFT22kHz16BitMono', 'SPWF_SRENGINE', 'SRARoot',
    'ISpeechGrammarRule', 'eLEXTYPE_PRIVATE16', 'SVF_Emphasis',
    'SPXRO_Alternates_SML', 'SpeechCategoryAudioOut',
    'DISPID_SGRInitialState', 'ISpeechPhraseReplacements',
    'ISpeechAudioStatus', 'SPAS_CLOSED', 'SVP_16',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SABIMinNotification',
    'SpeechWordType', '_ISpeechVoiceEvents',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRuleChildren',
    'SVP_0', 'eLEXTYPE_LETTERTOSOUND', 'SPXMLRESULTOPTIONS',
    'SVSFParseAutodetect', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGetFormat', 'SECFIgnoreKanaType', 'SPAUDIOSTATE',
    'DISPID_SWFEBitsPerSample', 'ISpeechVoice', 'DISPID_SASetState',
    'DISPID_SRCVoice', 'DISPID_SLPPartOfSpeech', 'SP_VISEME_19',
    'SPADAPTATIONRELEVANCE', 'DISPID_SLWsItem',
    'SpeechAudioFormatGUIDText', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVPause', 'SPBINARYGRAMMAR', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SREStreamEnd',
    'SpeechAudioState', 'SpeechStreamSeekPositionType',
    'SpeechVisemeFeature', 'SGRSTTDictation', 'DISPID_SWFEBlockAlign',
    'DISPID_SPIEngineId', 'SpeechSpecialTransitionType',
    'SPEI_SR_BOOKMARK', 'SPDKL_LocalMachine', 'DISPID_SGRAddState',
    'ISpeechWaveFormatEx', 'DISPID_SPRFirstElement',
    'DISPID_SVSLastBookmark', 'SRSActiveAlways', 'SpeechAudioVolume',
    'SPSNotOverriden', 'SRATopLevel', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechGrammarRuleState', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechBaseStream', 'SpeechVisemeType',
    'DISPID_SRCEStartStream', 'ISpShortcut',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPAs_NewEnum',
    'ISpeechPhraseRules', 'SGRSTTRule', '_RemotableHandle',
    'DISPID_SOTsCount', 'DISPID_SASFreeBufferSpace',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechLexiconWord', 'SINoise',
    'SDTAlternates', 'DISPID_SRCPause', 'SpeechTokenKeyAttributes',
    'SGDSInactive', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPIRetainedSizeBytes', 'SVSFNLPSpeakPunc', 'SP_VISEME_12',
    'SPSTREAMFORMATTYPE', 'DISPID_SPAPhraseInfo',
    'SPRST_ACTIVE_ALWAYS', 'SVSFIsXML', 'SPSHT_Unknown', 'SVP_6',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechRecoProfileProperties', 'ISpeechDataKey', 'SPINTERFERENCE',
    'DISPID_SRCEPhraseStart', 'DISPID_SADefaultFormat',
    'SPEI_MIN_TTS', 'DISPID_SLPSymbolic', 'SPSHORTCUTPAIRLIST',
    'SpeechTokenIdUserLexicon', 'ISpObjectWithToken',
    'SVEWordBoundary', 'SPWT_LEXICAL', 'ISpeechVoiceStatus',
    'SRAONone', 'ISpeechGrammarRules', 'DISPID_SVSpeakStream',
    'eLEXTYPE_PRIVATE7', 'SpMMAudioIn', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPRuleName', 'SVSFPurgeBeforeSpeak', 'ISpeechRecoResult',
    'ISpeechGrammarRuleStateTransition', 'SREAudioLevel',
    'eLEXTYPE_PRIVATE5', 'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPRuleParent', 'SPDKL_CurrentConfig', 'ISpRecognizer2',
    'UINT_PTR', 'DISPID_SOTs_NewEnum', 'DISPID_SLWType',
    'DISPID_SRGCmdSetRuleState', 'SAFT32kHz8BitMono', 'SpShortcut',
    'SPEI_START_INPUT_STREAM', 'eLEXTYPE_PRIVATE9',
    'SAFT44kHz16BitMono', 'ISpeechRecoResultTimes', 'SPEI_RESERVED3',
    'SPEI_SR_PRIVATE', 'SVSFParseSapi', 'SRAInterpreter',
    'SPWORDTYPE', 'SWPKnownWordPronounceable',
    'DISPID_SVESentenceBoundary', 'IEnumString',
    'DISPID_SGRAttributes', 'SpeechRetainedAudioOptions',
    'SGDSActiveUserDelimited', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPLO_STATIC', 'SPRULESTATE', 'SPWORDPRONOUNCEABLE',
    'SpeechBookmarkOptions', 'DISPID_SpeechPhoneConverter',
    'SVF_Stressed', 'SVF_None', 'DISPID_SPACommit',
    'SpeechRecoContextState', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEHypothesis', 'SSTTWildcard', 'SPEI_SOUND_START',
    'SAFT12kHz8BitStereo', 'ISpeechFileStream',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_RESERVED10', 'ISpDataKey',
    'eLEXTYPE_PRIVATE10', 'DISPID_SVDisplayUI', 'SITooFast',
    'DISPID_SDKDeleteKey', 'SREStateChange',
    'DISPID_SGRSAddRuleTransition', 'SPDKL_CurrentUser',
    'SPPS_NotOverriden', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechRecoContext', 'DISPID_SOTMatchesAttributes',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpRecognizer3',
    'SAFT16kHz16BitStereo', 'SRADynamic', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechRecoContext', 'DISPID_SOTGetStorageFileName',
    'DISPID_SOTGetAttribute', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEEnginePrivate',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_PHRASE_START',
    ...
    'SAFTGSM610_22kHzMono', 'SPVOICESTATUS', 'DISPID_SGRId',
    'DISPID_SRCEBookmark', 'SITooSlow', 'DISPID_SVEPhoneme',
    'SAFT11kHz16BitMono', 'STSF_LocalAppData',
    'DISPID_SRGCmdLoadFromMemory', 'SpAudioFormat', 'ISpRecoGrammar',
    'SpeechDiscardType', 'SLTApp', 'ISpeechLexiconWords',
    'DISPID_SVVoice', 'DISPID_SBSSeek', 'ISpPhrase',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE17', 'SPSLMA',
    'SPWT_PRONUNCIATION', 'DISPID_SpeechRecoResultTimes',
    'ISpNotifySink', 'SPINTERFERENCE_NONE', 'SRTEmulated',
    'SPAUDIOOPTIONS', 'ISpeechResourceLoader',
    'SGLexicalNoSpecialChars', 'DISPID_SPRuleId', 'SSTTDictation',
    'SAFTExtendedAudioFormat', 'SPVPRIORITY', 'DISPID_SRStatus',
    ...
    'ISpStreamFormatConverter', 'DISPID_SPISaveToMemory',
    'SpeechRecoEvents', 'SREFalseRecognition', 'SRERequestUI',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechGrammarRule',
    'SINoSignal', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SLPType',
    'SPDATAKEYLOCATION', 'DISPID_SRCEPropertyStringChange',
    'SSSPTRelativeToEnd', 'DISPID_SPRNumberOfElements', 'SPEI_MAX_SR',
    'ISpResourceManager', 'SpeechRegistryUserRoot', 'SPVPRI_NORMAL',
    'DISPID_SPPsItem', 'Speech_Max_Pron_Length',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTSetId',
    'DISPID_SLPPhoneIds', 'DISPID_SOTsItem', 'SGDisplay',
    'SPFILEMODE', 'SRESoundStart', 'SPEVENTSOURCEINFO',
    'DISPID_SRCEInterference', 'SECFIgnoreCase',
    'SpeechTokenValueCLSID', 'ISpeechBaseStream',
    'SpTextSelectionInformation', 'SPWORDPRONUNCIATION',
    'SpeechAllElements', 'DISPID_SPPValue', 'SSFMOpenForRead',
    'SPAS_PAUSE', 'DISPID_SRCreateRecoContext', 'SPEI_UNDEFINED',
    'SPEI_RESERVED5', 'SPTEXTSELECTIONINFO', 'SPSEMANTICERRORINFO',
    'DISPID_SVEBookmark', 'DISPID_SpeechRecognizer', 'SPAUDIOSTATUS',
    'SVP_1', 'SpNotifyTranslator', 'SVP_2', 'SPCT_DICTATION',
    'SpeechRuleState', 'ISpNotifyTranslator', 'SGDSActive',
    'ISpEventSink', 'DISPID_SPAStartElementInResult', 'SWTAdded',
    'SPSHT_OTHER', 'DISPID_SRRSaveToMemory', 'DISPID_SPEsItem',
    'Speech_Default_Weight', 'SVEAudioLevel', 'DISPID_SLGetWords',
    'DISPID_SVSInputSentencePosition', 'SBOPause',
    'DISPID_SRGetPropertyString', 'SAFT16kHz16BitMono',
    'tagSPPROPERTYINFO', 'ISpRecoCategory', 'SVSFParseSsml',
    'SPRST_NUM_STATES', 'SRSInactive', 'DISPID_SMSAMMHandle',
    'ISpeechAudio', 'SPEI_RECO_STATE_CHANGE', 'SVP_8',
    ...
    'ISpeechPhraseProperty', 'DISPID_SRGCmdLoadFromObject',
    'SDTDisplayText', 'SpPhraseInfoBuilder',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEVENT', 'DISPID_SGRSTWeight',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechCategoryAudioIn',
    'ISpRecoContext2', 'SREBookmark', 'SPGS_DISABLED',
    ...
    'DISPID_SVEAudioLevel', 'SPEI_MIN_SR', 'DISPID_SFSOpen',
    'SVEEndInputStream', 'SVP_21', 'eLEXTYPE_USER', 'SPEI_RESERVED1',
    'SRCS_Disabled', 'SpeechGrammarState', 'SAFTADPCM_8kHzMono',
    'DISPID_SDKSetBinaryValue', 'DISPID_SAVolume',
    'DISPID_SPEEngineConfidence', 'SPWT_DISPLAY', 'SpResourceManager',
    ...
    'SpeechAudioProperties', 'DISPID_SREmulateRecognition',
    'DISPID_SLGetPronunciations', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE2', 'DISPID_SOTCategory', 'DISPID_SVSPhonemeId',
    ...
    'SpeechTokenKeyFiles', 'DISPID_SDKEnumValues', 'SPPARTOFSPEECH',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpObjectTokenCategory', 'DISPID_SVSRunningState',
    'DISPID_SVGetVoices', 'SVP_19', 'eLEXTYPE_APP', 'DISPID_SGRSRule',
    ...
    'SPEI_SENTENCE_BOUNDARY', 'SPFM_OPEN_READONLY', 'SPPS_Modifier',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SOTCId', 'SP_VISEME_7',
    'SPFM_OPEN_READWRITE', 'SWTDeleted', 'DISPID_SRCResume',
    'DISPID_SpeechAudio', 'SGLexical', 'DISPID_SVSInputWordPosition',
    'SPFM_CREATE', 'SP_VISEME_14', 'ISpLexicon', 'DISPID_SPPName',
    'SPBO_PAUSE', 'DISPID_SpeechLexiconProns', 'SPVPRI_OVER',
    'DISPID_SRGRecoContext', 'DISPID_SAFGetWaveFormatEx', 'SPSMF_UPS',
    'DISPID_SVSCurrentStreamNumber', 'SPRECOGNIZERSTATUS',
    'SPPHRASEPROPERTY', 'SpUnCompressedLexicon',
    'DISPID_SPRs_NewEnum', 'ISpStreamFormat', 'eLEXTYPE_PRIVATE8',
    'SP_VISEME_17', 'DISPID_SVEStreamEnd', 'SSTTTextBuffer',
    'SPVISEMES', 'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE6',
    'SRTSMLTimeout', 'STCInprocServer',
    'SpeechPropertyComplexResponseSpeed', 'SPAR_Medium',
    'DISPID_SpeechPhraseRule', 'SAFT44kHz8BitMono',
    'eLEXTYPE_PRIVATE20', 'eWORDTYPE_DELETED',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_RESERVED9',
    'DISPID_SDKEnumKeys', 'SGRSTTEpsilon', 'DISPID_SVSpeak',
    'SAFT32kHz8BitStereo', 'STSF_CommonAppData',
    'SAFT24kHz8BitStereo', 'SAFTADPCM_11kHzMono', 'SVP_4', 'SVP_13',
    'DISPID_SPIProperties', 'DISPID_SPPConfidence',
    'DISPID_SpeechAudioBufferInfo', 'IInternetSecurityManager',
    'ISpNotifySource', 'ISpAudio', 'DISPID_SAFType',
    'DISPID_SGRSTType', 'SVP_3', 'ISpeechPhraseElements', 'SVP_11',
    'DISPID_SLPLangId', 'SECNormalConfidence',
    'DISPID_SPELexicalForm', 'SDTLexicalForm', 'DISPID_SPPsCount',
    'SPSInterjection', 'ISpeechLexiconPronunciations',
    'DISPID_SRAudioInputStream', 'SGRSTTWord',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTRemove',
    'tagSPTEXTSELECTIONINFO', 'SDA_No_Trailing_Space',
    ...
    'ISpRecoContext', 'ISpStream', 'ISpeechObjectTokenCategory',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCERequestUI',
    'ISpeechCustomStream', 'SPPHRASERULE', 'DISPID_SRProfile',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRGetRecognizers',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEI_REQUEST_UI',
    '_SPAUDIOSTATE', 'DISPID_SOTGetDescription',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechVoiceEvent',
    'SpeechCategoryAppLexicons', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE12',
    'ISpeechPhraseProperties', 'ISpeechPhraseAlternate',
    'SVSFDefault', 'SPBOOKMARKOPTIONS', 'SPEI_INTERFERENCE',
    'DISPID_SPEsCount', 'SpeechPartOfSpeech',
    'SDA_One_Trailing_Space', 'DISPID_SpeechAudioFormat',
    'STSF_AppData', 'SVSFlagsAsync', 'DISPIDSPTSI',
    'DISPID_SGRSTs_NewEnum', 'SAFTCCITT_ALaw_44kHzStereo',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRRTOffsetFromStart',
    'SAFT12kHz16BitStereo', 'SDTReplacement',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGIsPronounceable',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFT32kHz16BitMono',
    'DISPID_SVAudioOutputStream', 'DISPID_SCSBaseStream',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SITooQuiet', 'SP_VISEME_2',
    'DISPID_SRRTLength', 'DISPID_SRAudioInput',
    'DISPID_SVSLastResult', 'SPSERIALIZEDPHRASE',
    'DISPID_SRRTTickCount', 'SpeechCategoryRecoProfiles',
    'DISPID_SPRText', 'SPXRO_SML', 'SPEVENTENUM',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPRules_NewEnum',
    'SAFT8kHz8BitMono', 'SPRST_INACTIVE', 'SPCATEGORYTYPE',
    'DISPID_SGRSTNextState', 'DISPID_SPRulesItem',
    'SpeechGrammarTagUnlimitedDictation', 'ISequentialStream',
    'DISPID_SASCurrentSeekPosition', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCBookmark', 'DISPID_SPEAudioSizeBytes', 'SPEI_VISEME',
    'SRADefaultToActive', 'SDKLCurrentConfig', 'DISPID_SMSADeviceId',
    'STCInprocHandler', 'SRAExport', 'SPPS_Noncontent',
    'ISpeechRecognizer', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRGReset', 'DISPID_SGRSTransitions', 'eLEXTYPE_PRIVATE11',
    'SVEStartInputStream', 'DISPID_SGRsAdd',
    'DISPID_SPEAudioTimeOffset', 'SFTInput',
    'DISPID_SAFSetWaveFormatEx', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRAddResource', 'DISPID_SRRAlternates',
    'DISPID_SpeechAudioStatus', 'SPGS_ENABLED',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_VOICE_CHANGE',
    'eLEXTYPE_PRIVATE15', 'SpWaveFormatEx', 'SVESentenceBoundary',
    'SpeechLexiconType', 'SP_VISEME_0', 'DISPID_SPAsItem',
    'SpeechVoiceSpeakFlags', 'SAFT44kHz8BitStereo', 'DISPID_SVSkip',
    'SPCT_SLEEP', 'SAFTADPCM_22kHzStereo', 'DISPID_SLPsItem',
    'SRERecognition', 'SPINTERFERENCE_NOISE', 'SDTRule',
    'DISPID_SPPId', 'DISPID_SOTDisplayUI', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFTADPCM_22kHzMono', 'SPAS_RUN', 'SAFT24kHz16BitMono',
    'SPSHT_EMAIL', 'DISPID_SRSAudioStatus', 'SAFTGSM610_8kHzMono',
    'SPEI_SOUND_END', 'DISPID_SpeechXMLRecoResult', 'SASRun',
    'SVP_12', 'DISPID_SRGId', 'eLEXTYPE_RESERVED8',
    'DISPID_SMSGetData', 'ISpeechLexiconPronunciation',
    '__MIDL_IWinTypes_0009', 'SPAO_RETAIN_AUDIO', 'SPWF_INPUT',
    'SP_VISEME_10', 'SpeechLoadOption', 'SVEVoiceChange',
    'DISPID_SVAlertBoundary', 'DISPID_SGRs_NewEnum', 'SPRULE',
    'DISPID_SVPriority', 'DISPID_SDKGetBinaryValue', 'SP_VISEME_6',
    'DISPID_SPRuleNumberOfElements', 'SAFT11kHz16BitStereo',
    'SPAS_STOP', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVSLastStreamNumberQueued', 'SPINTERFERENCE_TOOQUIET',
    'SpVoice', 'DISPID_SRCRecognizer', 'SRTAutopause',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechPhraseRules',
    'DISPID_SPARecoResult', 'SpeechStreamFileMode',
    'DISPID_SVAudioOutput', 'SpeechVoiceEvents',
    'SpeechGrammarTagWildcard', 'DISPID_SLAddPronunciation',
    'eLEXTYPE_USER_SHORTCUT', 'SPSVerb', 'DISPID_SLWPronunciations',
    'DISPID_SPCIdToPhone', 'DISPID_SWFESamplesPerSec',
    'DISPID_SDKSetStringValue', 'SDTPronunciation',
    'SpeechTokenShellFolder', 'SpeechCategoryRecognizers',
    'DISPID_SRRTStreamTime', 'DISPID_SVSInputWordLength',
    'SpeechPropertyLowConfidenceThreshold', 'ISpEventSource',
    'SpFileStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SDTAll',
    'SpeechGrammarRuleStateTransitionType', 'SPRECOSTATE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SGRSAddWordTransition',
    'SpeechVoicePriority', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SGRSTRule', 'SREPhraseStart',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechInterference',
    'ISpMMSysAudio', 'ISpeechRecognizerStatus', 'SPFM_NUM_MODES',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPIAudioSizeTime',
    'SP_VISEME_18', 'DISPID_SGRName', 'SpeechTokenContext',
    'SPPS_Unknown', 'SPGRAMMARWORDTYPE', 'ISpSerializeState',
    'DISPID_SDKSetLongValue', 'SDKLDefaultLocation', 'SREAllEvents',
    'DISPID_SDKDeleteValue', 'SPCONTEXTSTATE', 'SPAR_Unknown',
    'SRESoundEnd', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPAsCount', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSTsItem', 'SAFT16kHz8BitStereo',
    'SPPS_RESERVED2', 'DISPID_SGRSTText', 'DISPID_SPPParent',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRRDiscardResultInfo',
    'DISPIDSPTSI_ActiveOffset', 'SPPS_LMA', 'DISPID_SPRuleConfidence',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRRecognizer',
    'SP_VISEME_4', 'ISpRecoGrammar2', 'DISPID_SRRSpeakAudio',
    'SASStop', 'DISPID_SPIReplacements', 'SVP_10', 'SpMMAudioOut',
    'DISPID_SPRsCount', 'SPSSuppressWord', 'SPSHT_NotOverriden',
    'SpNullPhoneConverter', 'DISPID_SOTCreateInstance',
    'DISPID_SRRSetTextFeedback', 'DISPID_SBSWrite',
    'SpeechAddRemoveWord', 'SVPNormal', 'SpeechRecognitionType',
    'DISPID_SASState', 'DISPID_SVEStreamStart',
    'DISPID_SRGDictationLoad', 'SVEBookmark', 'SECLowConfidence',
    'DISPID_SPPs_NewEnum', 'SPCT_SUB_DICTATION', 'DISPIDSPRG',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVVolume',
    'DISPID_SWFEChannels', 'DISPID_SpeechObjectToken',
    'ISpeechMMSysAudio',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechLexicon', 'DISPID_SRCEPropertyNumberChange',
    '_ISpeechRecoContextEvents', 'DISPID_SAEventHandle',
    'DISPID_SPPFirstElement', 'DISPID_SLWsCount', 'DISPID_SOTId',
    'ISpPhoneticAlphabetSelection', 'SVPAlert', 'ISpPhraseAlt',
    'ISpProperties', 'DISPID_SpeechRecoResult', 'SPAO_NONE',
    'DISPID_SRDisplayUI', 'DISPID_SPEDisplayText',
    'SREPropertyNumChange', 'DISPID_SRRAudioFormat', 'SP_VISEME_21',
    'SITooLoud', 'DISPID_SpeechFileStream', 'SAFT8kHz8BitStereo',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPIGetText',
    'DISPID_SpeechRecognizerStatus', 'SAFT11kHz8BitStereo',
    'SRAORetainAudio', 'DISPID_SpeechPhraseInfo', 'SRTStandard',
    'SPSNoun', 'SpeechPropertyNormalConfidenceThreshold',
    'SPPS_RESERVED1', 'SPRST_ACTIVE', 'SLTUser',
    'ISpObjectTokenCategory', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechVoiceStatus', 'ISpeechPhoneConverter',
    'DISPID_SPPNumberOfElements', 'SVEPrivate', 'DISPID_SRCESoundEnd',
    'SLOStatic', 'SpeechEmulationCompareFlags', 'ISpeechRecoResult2',
    'IStream', 'DISPID_SRGSetTextSelection', 'DISPID_SGRsItem',
    'SAFT12kHz16BitMono', 'SPINTERFERENCE_TOOSLOW',
    'SpeechDisplayAttributes', 'SPSModifier',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechEngineProperties', 'SPPS_Function', 'DISPID_SGRsCount',
    'DISPID_SVStatus', 'SPEI_WORD_BOUNDARY', 'DISPID_SRIsUISupported',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechMMSysAudio',
    'DISPID_SLRemovePronunciation', 'SDTProperty',
    'ISpeechXMLRecoResult', 'SPLEXICONTYPE', 'ISpeechPhraseRule',
    'DISPID_SPEAudioStreamOffset', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTIsUISupported', 'SPPS_Interjection', 'SVSFParseMask',
    'SGSEnabled', 'SPSUnknown', 'SAFTNoAssignedFormat',
    'DISPID_SVIsUISupported', 'SPEI_END_SR_STREAM',
    'SAFT22kHz8BitMono', 'DISPID_SGRSTPropertyName',
    'DISPID_SLPs_NewEnum', 'SAFT8kHz16BitMono', 'ISpeechMemoryStream',
    ...
    'DISPID_SpeechPhraseProperties', 'SAFTADPCM_44kHzStereo',
    'DISPID_SWFEExtraData', 'SPFM_CREATE_ALWAYS', 'DISPID_SAFGuid',
    'SGRSTTWildcard', 'DISPID_SOTCGetDataKey', 'SpeechFormatType',
    'DISPID_SRGetPropertyNumber', 'SpSharedRecognizer',
    'SpSharedRecoContext', 'SRTReSent', 'DISPID_SABIBufferSize',
    'SPEI_MAX_TTS', 'eLEXTYPE_RESERVED6', 'ISpXMLRecoResult',
    'DISPID_SRCCreateGrammar', 'SVSFPersistXML',
    'SAFTADPCM_44kHzMono', 'SPEI_START_SR_STREAM', 'SVP_18',
    'ISpeechLexiconWord', 'SpeechGrammarWordType', 'SVSFVoiceMask',
    'SAFT22kHz16BitStereo', 'SPGRAMMARSTATE', 'LONG_PTR',
    'SREPropertyStringChange', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechVoice',
    'DISPID_SpeechLexiconPronunciation', 'SAFTCCITT_ALaw_11kHzMono',
    'SPCS_DISABLED', 'SpPhoneticAlphabetConverter',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SDKOpenKey',
    'SPPROPERTYINFO', 'SSFMCreate', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE1', 'SAFTCCITT_ALaw_8kHzMono',
    'eLEXTYPE_PRIVATE14', 'SpeechRuleAttributes', 'STCLocalServer',
    'SVP_7', 'DISPID_SpeechRecoContextEvents', 'SP_VISEME_16',
    'DISPID_SVSVisemeId', 'SpeechRunState', 'SpeechEngineConfidence',
    'SREPrivate', 'DISPID_SGRSTPropertyId', 'SAFTNonStandardFormat',
    'SFTSREngine'
]

_check_version('1.1.14', 1616922985.817463)
